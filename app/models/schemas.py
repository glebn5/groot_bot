...
class ParsedAction(BaseModel):
    ...
    is_goal_add: bool = Field(default=False, description="Whether user wants to set a monthly goal")
    goal_text: Optional[str] = Field(None, description="Text of monthly goal")
    target_month: Optional[str] = Field(None, description="Target month for goal in YYYY-MM format (e.g. '2026-09')")
    is_goals_query: bool = Field(default=False, description="Whether user is asking to view monthly goals")
    is_recurring_add: bool = Field(default=False, description="Whether user wants to create a recurring task or habit")
    recurring_title: Optional[str] = Field(None, description="Title of the recurring task or habit")
    repeat_type: Optional[str] = Field(None, description="Type of recurrence ('daily', 'weekly', 'interval_days', 'custom_cron')")
    repeat_days: List[str] = Field(default_factory=list, description="Days of week for weekly recurrence (e.g. ['mon', 'wed', 'fri'])")
